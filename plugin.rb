# name: plugin-meta-tags
# about:  Fix meta tags
# version: 0.0.1
# authors: Terrapop

enabled_site_setting :plugin_meta_tags_enabled
 ...
 reloadable_patch do |plugin|
  ApplicationHelper.module_eval do
    ...
    def crawlable_meta_data(opts = nil)
        ...
        result << tag(:meta, property: 'fb:app_id', content: "119130391441497")
        result << tag(:meta, property: 'fb:pages', content: "211482380627")
